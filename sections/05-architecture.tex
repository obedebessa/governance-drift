...
records are absent or decayed, only the basis-dependent components and the
total governance verdict degrade to undecidable (their entries of $\ObsMask$
are zero). The desired/observed configuration component remains comparable
when its own evidence contract is satisfied; the evaluator must report this
partial result rather than either total consistency or total ignorance.
