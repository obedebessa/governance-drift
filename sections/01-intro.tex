...
the laboratory's injection-to-verdict wall-clock observations.
...
\item \textbf{Bounded Kubernetes/GitOps laboratory} (empirical, executed): a
...
run per scenario, all nine baselines were consistent and all nine verdicts
matched the expected class, with 0.137--8.571~s injection-to-verdict latency
(\cref{sec:lab}). The run establishes feasibility and occurrence on this
stack, not prevalence, reliability, or a latency distribution.
\end{enumerate}
...
the larger repeated-trial laboratory protocol remains a future extension.
