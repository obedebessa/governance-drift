...
The six components are equivalent only as coordinates of the governance
distance vector; they are \emph{not} equivalent in consequence. A raw count
...
\begin{table*}[t]
\centering
\caption{Class-Resolved Risk Channels and Default Response Families. These
Rows Are Not a Scalar Ranking: Actual Severity Depends on Blast Radius,
Exposure Duration, Reversibility, Consequence, and Evidence Coverage.}
\label{tab:severity}
\footnotesize
