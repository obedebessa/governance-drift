...
\emph{External}: the bounded laboratory (\cref{sec:lab}) establishes that the
nine classes can be induced and correctly distinguished through real
Kubernetes/GitOps interfaces on one pinned stack. It does not transfer the
closed-world rates quantitatively or estimate field prevalence, reliability,
stream loss, or performance under load; the repeated, churn-controlled
protocol and its refutation conditions remain necessary for those questions.
