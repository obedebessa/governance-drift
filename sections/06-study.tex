...
\emph{External}: no claim transfers quantitatively; the laboratory protocol
(\cref{sec:lab}) exists precisely to measure the same matrix with real
components, wall-clock latencies, and noisy streams, and its refutation
conditions are stated there.
