...
\begin{tikzpicture}[node distance=3.2mm and 4mm]
  % approval event
  \node[human, minimum width=22mm] (appr) at (0,0)
    {approval history\\{\smlbl $t_0<t_1<\cdots<t_k$}};
  \node[attn, below=2.5mm of appr, minimum width=20mm] (snap)
    {$G^{(0)}\to\cdots\to B_x(t)$\\{\smlbl $m_B,\delta_B,\dig(\pi_B),A_B^{\rm proof},\iota_B,\sigma_B$}};
